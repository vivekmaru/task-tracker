...
ALTER TABLE ticket_events
    ...
    CHECK (type IN ('created', 'proposed', 'claimed', 'heartbeat', 'checkpointed', 'updated', 'completed', 'failed', 'blocked', 'expired', 'cancelled', 'ready', 'reopened', 'unblocked', 'review_requested', 'reviewed', 'archived'));
